# got this file from somewhere, I think it must be from google, better than direct referecing the models, but no big deal either way
import os, re, types

PACKAGE = 'worldwide.models'
MODEL_RE = r"^.*.py$"
